...
def run_aucmedi(train_x, train_y, test_x, test_y, ds_meta, target_path):
    ...
    img_aug = ImageAugmentation(flip = True,
                                ...
                                saturation = True,
                                hue = True,
                                scale = True, # raus machen todo
                                crop = False,
                                grid_distortion = False,
                                compression = False,
                                gaussian_noise = True, # reduce overfitting, deal wiht imperfect data
                                gaussian_blur = False, # deaktiviert lassen, für nur scharfe resulution train bilder sinnvoll
                                downscaling = False,
                                gamma = False, # rein mache todo
                                elastic_transform = True) # raus todo
